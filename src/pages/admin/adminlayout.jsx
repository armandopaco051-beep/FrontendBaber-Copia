...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'permisos-personal', label: 'Gestionar permisos del personal', path: '/admin/permisos-personal', permiso: 'barberos.ver' },
    ],
  },
  {
    id: 'clientes',
    ...
    items: [
      ...
      { id: 'encuestas-satisfaccion', label: 'CU30 Gestionar encuesta de satisfaccion', path: '/admin/encuestas-satisfaccion', permiso: 'encuestas_satisfaccion.ver' },
      { id: 'reclamos-sugerencias', label: 'CU31 Gestionar reclamos y sugerencias', path: '/admin/reclamos-sugerencias', permiso: 'reclamos_sugerencias.ver' },
      { id: 'respuestas-reclamos', label: 'CU32 Gestionar respuesta a reclamos', path: '/admin/respuestas-reclamos', permiso: 'reclamos_sugerencias.responder' },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'paquetes-servicios', label: 'CU28 Gestionar paquetes de servicios', path: '/admin/paquetes-servicios', permiso: 'paquetes_servicios.ver' },
      { id: 'recomendaciones-cuidado', label: 'CU29 Gestionar recomendaciones de cuidado', path: '/admin/recomendaciones-cuidado', permiso: 'recomendaciones_cuidado.ver' },
      { id: 'diagnosticos-capilares', label: 'Registrar diagnostico capilar', path: '/admin/diagnosticos-capilares', permiso: 'atenciones.ver' },
      { id: 'portafolio-trabajos', label: 'Gestionar portafolio de trabajos', path: '/admin/portafolio-trabajos', permiso: 'servicios.ver' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'estaciones-trabajo', label: 'CU26 Gestionar estaciones de trabajo', path: '/admin/estaciones-trabajo', permiso: 'estaciones_trabajo.ver' },
      { id: 'asignaciones-estaciones', label: 'CU27 Asignar barbero a estacion', path: '/admin/asignaciones-estaciones', permiso: 'asignaciones_estaciones.ver' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ventas-cuotas', label: 'CU33 Gestionar venta por cuotas', path: '/admin/ventas-cuotas', permiso: 'ventas.ver' },
      { id: 'campanias-fidelizacion', label: 'Gestionar campanias de fidelizacion', path: '/admin/campanias-fidelizacion', permiso: 'ventas.ver' },
...
const PAGE_INFO = {
  ...
  'permisos-personal': { title: 'Permisos del personal', sub: 'Gestiona permisos laborales de barberos' },
  clientes: { title: 'Gestion de clientes', sub: 'Consulta clientes, historial y frecuencia de visitas' },
  'encuestas-satisfaccion': { title: 'Encuestas de satisfaccion', sub: 'Administra formularios de evaluacion del cliente' },
  'reclamos-sugerencias': { title: 'Reclamos y sugerencias', sub: 'Gestiona solicitudes registradas por clientes' },
  'respuestas-reclamos': { title: 'Respuesta a reclamos', sub: 'Registra respuestas y estados de seguimiento' },
  servicios: { title: 'Gestion de servicios', sub: 'Administra categorias, servicios, duracion y precio' },
  'paquetes-servicios': { title: 'Paquetes de servicios', sub: 'Agrupa servicios activos en ofertas comerciales' },
  'recomendaciones-cuidado': { title: 'Recomendaciones de cuidado', sub: 'Registra indicaciones posteriores al servicio' },
  'diagnosticos-capilares': { title: 'Diagnosticos capilares', sub: 'Registra diagnosticos asociados a atenciones' },
  'portafolio-trabajos': { title: 'Portafolio de trabajos', sub: 'Gestiona trabajos realizados y revision administrativa' },
  ...
  'estaciones-trabajo': { title: 'Estaciones de trabajo', sub: 'Administra espacios fisicos de atencion de la barberia' },
  'asignaciones-estaciones': { title: 'Asignaciones de estaciones', sub: 'Asigna barberos a estaciones disponibles por turno' },
  ...
  'ventas-cuotas': { title: 'Venta por cuotas', sub: 'Registra y consulta planes de pago por cuotas' },
  'campanias-fidelizacion': { title: 'Campanias de fidelizacion', sub: 'Administra beneficios para clientes frecuentes' },
